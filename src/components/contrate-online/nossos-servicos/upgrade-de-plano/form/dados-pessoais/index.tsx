...
import { DadosPessoaisSchema } from "@/components/contrate-online/nossos-servicos/upgrade-de-plano/form/schema";
import { Icons } from "@/components/ui/icons";
import { z } from "zod";
import { fetchClientePorEmail } from "@/app/contrate-online/actions/novo-cliente/select";
import { toast } from "sonner";
import { fields } from "@/components/contrate-online/nossos-servicos/upgrade-de-plano/form/dados-pessoais/campos";
import { useClienteStore } from "@/hooks/contrate-online/cliente-nr/nossos-servicos/useDadosCliente";

export const FormDadosPessoais: React.FC<{ onNext: () => void }> = ({ onNext }) => {
