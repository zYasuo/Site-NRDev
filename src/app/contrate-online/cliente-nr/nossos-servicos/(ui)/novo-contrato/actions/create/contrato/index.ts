...
import { ContratoData } from "@/app/contrate-online/cliente-nr/nossos-servicos/(ui)/novo-contrato/actions/create/contrato/types";
...
export async function ChamaRotaContrato(data: ContratoData) {
  const response = await fetch(`${process.env.NEXTAUTH_URL}/api/ixc/novo-cliente/fisico/create/contratos`, {
    method: "POST",
    headers: {
